...
public class DayReportSpacerFragment extends Fragment {
    CommittedTime associatedTime;
    CommittedTime lastTime;
    public DayReportSpacerFragment(CommittedTime c, CommittedTime last) {
        associatedTime = c;
        lastTime = last;
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_day_report_spacer, container, false);
    }
